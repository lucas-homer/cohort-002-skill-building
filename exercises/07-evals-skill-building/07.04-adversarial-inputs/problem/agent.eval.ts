...
evalite.each([
	...
	data: [
		...
		{
			input: createUIMessageFixture("I need to organize my schedule"),
		...
		{
			input: createUIMessageFixture("Book a flight for next month"),
			expected: { tool: null }, // Missing from, to, specific date
		},
		// Edge case: Conversational input with no action needed
		{
			input: createUIMessageFixture("Thanks for your help earlier!"),
			expected: { tool: null },
		},
